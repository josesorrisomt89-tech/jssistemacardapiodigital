  ...
  private getDefaultSettings(): ShopSettings {
    ...
    return {
      ...
      layout: { 
        ...
        status_open_color: '#28A745',
        status_closed_color: '#DC3545',
        header_text_color: '#FFFFFF',
        category_text_color: '#007BFF',
        form_background_color: '#FFFFFF',
        form_text_color: '#212529',
      ...
      loyalty_program: { 
        ...
        wheel_of_fortune: {
          ...
          prizes: [
            { label: '10% OFF', type: 'percentage', value: 10, couponCode: 'SORTE10', description: 'Prêmio da Roleta: 10% OFF', color: '#7C3AED' },
            { label: 'Tente de Novo', type: 'none', value: 0, couponCode: '', description: '', color: '#FBBF24' },
            { label: 'R$5 OFF', type: 'fixed', value: 5, couponCode: 'SORTE5', description: 'Prêmio da Roleta: R$5 OFF', color: '#7C3AED' },
            { label: 'Tente de Novo', type: 'none', value: 0, couponCode: '', description: '', color: '#FBBF24' },
            { label: 'Frete Grátis', type: 'free_shipping', value: 0, couponCode: 'SORTEFRETE', description: 'Prêmio da Roleta: Frete Grátis', color: '#7C3AED' },
            { label: 'Tente de Novo', type: 'none', value: 0, couponCode: '', description: '', color: '#FBBF24' },
            { label: '5% OFF', type: 'percentage', value: 5, couponCode: 'SORTE5P', description: 'Prêmio da Roleta: 5% OFF', color: '#7C3AED' },
            { label: 'Tente de Novo', type: 'none', value: 0, couponCode: '', description: '', color: '#FBBF24' },
          ]
        }
      },
